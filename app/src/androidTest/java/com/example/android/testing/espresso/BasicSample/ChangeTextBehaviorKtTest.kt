...
class ChangeTextBehaviorKtTest {
    ...
    private val stringToBeTyped = "123"

    @Test
    fun changeText_sameActivity_withValidInput() {
    ...
    @Test
    fun changeText_newActivity_withValidInput() {
        onView(withId(R.id.editTextUserInput))
            .perform(typeText(stringToBeTyped), closeSoftKeyboard())
    ...
    @Test
    fun changeText_sameActivity_withDifferentInput() {
        val newString = "abcdef"
        onView(withId(R.id.editTextUserInput))
    ...
    @Test
    fun changeText_newActivity_withDifferentInput() {
        val newString = "abcdef"
        onView(withId(R.id.editTextUserInput))
            .perform(typeText(newString), closeSoftKeyboard())
        onView(withId(R.id.activityChangeTextBtn)).perform(click())
